...
// Adiciona e remove classe jump; animaçao para o gato pular
const jump = () => {
...
const loop = setInterval(() => {
  ...
  const catSafeJump = 70; // Valor mínimo antes do gato encostar no bloco
  ...
  /// por isso se utiliza 'getComputedStyle()' para acessar estilos da classe gato
  ...
  if (
    ...
    cat.style.animation = "ghost-animation 2s infinite linear";
